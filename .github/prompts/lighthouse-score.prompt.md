...
- Keep in mind the lighthouse script is run against the live site(https://hvshs.com). The project needs to be deployed before running the lighthouse script again.
